...
var move_sprite_main = get_3dval(melee_move_list, move_id, 0, 0);
...
var move_sprite_main = get_3dval(melee_move_list, move_id, 0, 0);//UPDATE
var move_sprite_hitbox = get_3dval(melee_move_list, move_id, 0, 1);
var move_sprite_effect = get_3dval(melee_move_list, move_id, 0, 2);
move_sound_hit = get_3dval(melee_move_list, move_id, 0, 3);
move_sound_draw = get_3dval(melee_move_list, move_id, 0, 4);

var move_power = get_3dval(melee_move_list, move_id, 1, 0);
var move_cost = get_3dval(melee_move_list, move_id, 1, 1);
var move_knockback_rate = get_3dval(melee_move_list, move_id, 1, 4);
var move_juggle_rate = get_3dval(melee_move_list, move_id, 1, 5);
...
if  combo_num == combo_index and !attacking and !action and !guarding{
    ...
    hitbox.image_speed = fast_imgspd;
    hitbox.pow = 1;
