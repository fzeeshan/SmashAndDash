...
var move_sound_hit = get_3dval(range_move_list, move_id, 0, 4);
var move_sound_draw = get_3dval(range_move_list, move_id, 0, 5);
...
if sprite_index == move_sprite_main{
    if image_index == image_number - 5{
        ...
        missile.sound_hit = move_sound_hit;
        missile.team = team;
        missile.max_hits = 1;
        missile.cur_hits = 0;
    }
...
if  sprite_index != move_sprite_main and !attacking and !action{
    ...
    attacking = true;
    action = true;
    scr_play_sound(move_sound_draw,10,.75);
    hspd = 0;
    spd = walk_spd;
}
